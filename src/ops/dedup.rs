...
fn find_hash_duplicates() -> Result<Vec<DuplicateGroup>> {
...
fn find_name_duplicates() -> Result<Vec<DuplicateGroup>> {
    let cfg = inventory::load_config()?;
...
pub fn dedup(by_hash: bool, by_name: bool, json: bool) -> Result<()> {
    // Default: show both
